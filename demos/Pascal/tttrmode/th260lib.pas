...
const
  TH260_LIB_NAME = 'libth260';  //different from Windows
...
function  TH260_SetInputChannelEnable (devidx : LongInt; channel : LongInt; enable : LongInt) : LongInt;
  stdcall; external TH260_LIB_NAME;
function  TH260_SetInputDeadTime      (devidx: LongInt; channel: LongInt; tdcode: LongInt) : LongInt;   // New in v.2.0, TH 260 Pico after April 2015 only
  stdcall; external TH260_LIB_NAME;
